...
filename_input = "articlesSport.txt"  # Nombre de tu archivo de texto de entrada
filename_output = "articlesSport_cleaned.txt"  # Nombre del archivo de salida para los artículos limpios
    ...
    with open(filename_input, 'r', encoding='utf-8') as file_in, \
        ...
        for line in file_in:
            try:
                ...
                fields_to_remove = ['uri', 'isDuplicate', 'date', 'time', 'dateTime', 'dateTimePub', 'sim']
